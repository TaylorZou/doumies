package com.doumies.auth.config;
...
public class SwaggerConfiguration {
    ...
    public Docket restApi() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.doumies.auth.controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("OAuth2认证中心")
                ...
                .termsOfServiceUrl("http://www.doumies.com")
                .contact(new Contact("豆米", "git", "jocky48562@163.com"))
                .license("Open Source")
