...
import com.doumies.common.constant.RedisConstants;
...
public class AsyncServiceImpl implements IAsyncService {
    ...
    private final McsCouponTemplateMapper couponTemplateMapper;

    @Async("getAsyncExecutor")
    @Override
    public void asyncConstructCouponByTemplate(McsCouponTemplate template) {
     ...
     * 后八位：0 ~ 9 随机数构成
     *
     * @param template {@link McsCouponTemplate} 优惠券模板实体类
     * @return Set<String> 与 template.total 总优惠券数量
     */
    private Set<String> buildCouponCode(McsCouponTemplate template) {
