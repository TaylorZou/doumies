...
public class AttributeController {
    ...
    public Result list(Long categoryId, Integer type) {
        List<PcsAttribute> list = iPcsAttributeService.list(new LambdaQueryWrapper<PcsAttribute>()
                .eq(categoryId != null, PcsAttribute::getCategoryId, categoryId)
                .eq(type != null, PcsAttribute::getType, type)
        );
    ...
    public Result saveBatch(@RequestBody AttributeFormDTO attributeForm) {
        boolean result = iPcsAttributeService.saveBatch(attributeForm);
