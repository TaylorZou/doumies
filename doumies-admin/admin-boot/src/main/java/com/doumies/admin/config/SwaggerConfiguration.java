package com.doumies.admin.config;
...
public class SwaggerConfiguration {
    ...
    public Docket restApi() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.doumies.admin.controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .termsOfServiceUrl("https://www.doumies.com")
                .contact(new Contact("豆米技术", "git", "jocky48562@163.com"))
                .license("Open Source")
